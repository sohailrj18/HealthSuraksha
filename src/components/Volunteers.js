...
function Volunteers() {
  ...
  // const dataAugemented = useMemo(() => [...(volunteers || []), {}], [volunteers]);
  const dataAugemented = useMemo(() => [...data, {}], [data]);
      ...
      <div className="Volunteers">
        <div className="wrapper">
          ...
          >
            ...
            extended their time and effort towards collating and
            ...
            <div>
              {volunteers.map((volunteer, index) => (
                <div key={index}>
                  ...
                  <p>{volunteer.bio}</p>
                  <div>
                    <a href={volunteer.github} target='_blank' rel='noopener noreferrer'>
                      <GitHub size={16} />
                    </a>
